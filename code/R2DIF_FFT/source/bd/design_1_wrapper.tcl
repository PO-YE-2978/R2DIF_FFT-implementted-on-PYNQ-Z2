...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/PYNQ_Z2/R2DIF_FFT/R2DIF_FFT.cache/wt [current_project]
  set_property parent.project_path C:/PYNQ_Z2/R2DIF_FFT/R2DIF_FFT.xpr [current_project]
  set_property ip_repo_paths {
  C:/PYNQ_Z2/ip_repo/my_fft_top_ip_1.0
  C:/PYNQ_Z2/R2DIF_FFT/bram_switch_pack
} [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/PYNQ_Z2/R2DIF_FFT/R2DIF_FFT.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet C:/PYNQ_Z2/R2DIF_FFT/R2DIF_FFT.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/PYNQ_Z2/R2DIF_FFT/R2DIF_FFT.srcs/sources_1/bd/design_1/design_1.bd
  read_ip -quiet C:/PYNQ_Z2/R2DIF_FFT/R2DIF_FFT.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0.xci
